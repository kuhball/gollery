    ...
    function Chocolat(element, settings) {
        ...
        this.element.find(this.settings.imageSelector).each(function () {
            that.settings.images.push({
                ...
                download : $(this).attr('download_href'),
                src    : $(this).attr('href'),
                height : false,
                width  : false
            });
    ...
    $.extend(Chocolat.prototype, {
        ...
        appear : function(i) {
            ...
            this.elems.loader.stop().fadeOut(300, function() {
                ...
                that.elems.description
                    .attr('href', that.settings.images[i].download)
            });
        },
        ...
        markup : function() {
            ...
            this.elems.description = $('<a/>', {
                'class' : 'chocolat-description button',
                'href' : '',
                'download': ''
            }).appendTo(this.elems.bottom);
